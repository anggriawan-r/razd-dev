...
export default function Header() {
  ...
  return (
    <motion.header
      ...
      className="fixed inset-0 z-50 mx-auto flex h-16 w-full items-center justify-center border border-white border-opacity-20 bg-zinc-900 bg-opacity-75 backdrop-blur-md sm:top-6 sm:h-12 sm:w-max sm:rounded-md"
    >
