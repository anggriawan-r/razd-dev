...
function Intro() {
  ...
  return (
    <AnimatePresence>
      <div
        key="first"
        className="container relative -z-10 flex h-dvh w-full flex-col items-center justify-center px-4"
      >
      ...
      >
        <ChevronDownCircle
          className="absolute bottom-12 mx-auto block h-8 w-8 -translate-x-1/2 text-zinc-200 sm:h-10 sm:w-10"
          strokeWidth={1}
